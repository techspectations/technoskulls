...
public class ScrollingScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isLooping)
        {
            ...
            float leftBorder = Camera.main.ViewportToWorldPoint(new Vector3(0, 0, dist)).x - 25;
            float rightBorder = Camera.main.ViewportToWorldPoint(new Vector3(1, 0, dist)).x - 25;
