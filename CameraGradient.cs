...
public class CameraGradient : MonoBehaviour
{
    ...
    public float materialChangetime;
	...
	void Start () 
	{
		...
		backgroundPlane.AddComponent<MeshRenderer> ().material = matArrayRandom();
	}
    public Material matArrayRandom()
    {
        int i = Random.Range(0, material.Length);
        return material[i];
    }
	void Update()
	{
        materialChangetime -= Time.deltaTime;
